    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          ...
          <form action="sign_up.php"  method ="post" class="sign-up-form">
            ...
            <div class="input-field">
                <i class="fas fa-user"></i>
                <input type="text" name="role" placeholder="Role" list="default" >
                <datalist id="default">
                <option value="doctor">
                <option value="nurse">
                <option value="client">
            ...
            <div class="input-field">
              <i class="fas fa-lock"></i>
              <input type="password" name="Rpasswd" placeholder="Repeat Password">
            </div>
            <input type="submit" class="btn" name ="save" value="Signup" >
      ...
      <div class="panels-container">
        ...
        <div class="panel right-panel">
          ...
          <img src="img/nurse.svg" class="image" alt="" />
        </div>
      </div>
    </div>
