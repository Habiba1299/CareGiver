  ...
  <div class="container marketing">
    ...
    <div class="row">
      ...
      <i class="fas fa-clinic-medical"></i>
        <h2 class="mt-4">Find A Hospital</h2>
        <p>Some representative placeholder content for the three columns of text below the carousel. This is the first column.</p>
        <p><a class="" href="search-hospital.php">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4 promo-box">
        <i class="fas fa-pills"></i>
        <h2 class="mt-4">Find A pharmacy</h2>
        <p>Another exciting bit of representative placeholder content. This time, we've moved on to the second column.</p>
        <p><a class="" href="search-pharmacy.php">View details &raquo;</a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4 promo-box">
